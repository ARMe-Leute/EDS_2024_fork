...
#define VELOPIN 5     ///< Frequenzeingang Geschwindigkeit des Motors, grünes Kabel
#define BRKPIN 7      ///< Bremse des Motors, Weißes Kabel
#define PINU 8        ///< Eingang Hall-Signal U, gelbes Kabel
#define PINV 9        ///< Eingang Hall-Signal V, grünes Kabel
#define PINW 10       ///< Eingang Hall-Signal W, blaues Kabel
#define PWMPIN 11     ///< PWM Signal für den BLDC-Controller, Blaues Kabel
